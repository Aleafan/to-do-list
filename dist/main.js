...
function createProjectPage(project) {
  ...
  const progress = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('progress', {max: '100'});
  setProgressDisplay(project, progress);
  main.appendChild(progress);  

  const taskList = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('ul', {class: 'task-list'});
  main.appendChild(taskList);

  project.tasks.forEach(task => taskList.appendChild(createTaskLi(task, project)));

  const taskFormWrapper = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {id: 'task-form-wrapper'});
  ...
  const btnAddTask = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-menu btn-add'});
...
function createProjectHeader(project) {
  const header = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('header', {id: 'project-info'});
  ...
  const btnOptions = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', 'aria-label': 'show-options', class: 'btn-options'});
  btnOptions.appendChild((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'fas fa-ellipsis-h'}));
  ...
  if (project.description) {
    const description = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('p', {class: 'description'});
...
function showOptionsPopup(btnOptions, project) {
  const popupWrapper = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {id: 'popup-wrapper'});
  
  const projOptions = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('ul', {id: 'project-options'});
  popupWrapper.appendChild(projOptions);

  const liEdit = document.createElement('li');
  const btnEdit = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-proj-option'});
  btnEdit.append((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'fas fa-edit'}), 'Edit project');
  liEdit.appendChild(btnEdit);

  const liDelComplete = document.createElement('li');
  const btnDelComplete = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-proj-option'});
  btnDelComplete.append((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'fas fa-calendar-check'}), 'Delete completed tasks');
  liDelComplete.appendChild(btnDelComplete);

  const liDelete = document.createElement('li');
  const btnDelete = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-proj-option'});
  btnDelete.append((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'far fa-trash-alt'}), 'Delete project');
...
function handleProjectEdit(project) {
  // Create editing form
  const form = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('form', {id: 'edit-project'});
  
  const labelTitle = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('label', {for: 'project-title', class: 'visuallyhidden'});
  labelTitle.textContent = 'Project name';
  const inputTitle = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('input', {type: 'text', id: 'project-title', class: 'project-title', 
      placeholder: 'Project name', value: project.title, required: ''});

  const labelNotes = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('label', {for: 'project-notes', class: 'visuallyhidden'});
  labelTitle.textContent = 'Project notes';
  const inputNotes = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('textarea', {id: 'project-notes', row: '2', placeholder: 'Project notes'});
  inputNotes.textContent = project.description || '';

  const btnWrapper = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {class: 'btn-form-wrapper'});
  ...
  const btnCancel = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {class: 'btn-form btn-cancel'});
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.focusAtEnd)(inputTitle);
...
function toggleTaskForm() {
  ...
  if (taskFormWrapper.classList.contains('show-form')) {
    ...
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.focusAtEnd)(taskFormWrapper.querySelector('.task-title'));
  }
}


function createTaskLi(task, project) {
  const li = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('li', {role: 'button', 'aria-expanded': 'false', tabindex: '0'});
  if (task.complete) li.classList.add('checked');
  if (task.priority) li.classList.add('priority');

  const taskMain = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {class: 'task-main'});
  li.appendChild(taskMain);

  const btnCheck = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', 'aria-label': 'complete-task', class: 'btn-check'});
  btnCheck.appendChild((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'fas fa-check'}));
  ...
  const dateSpan = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('span', {class: 'due-date'});
  taskMain.appendChild(dateSpan);

  displayDate(task, dateSpan);

  const taskExtension = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {class: 'task-extension'});
  ...
  const taskOptions = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {class: 'task-options'});
  ...
  const btnCalendar = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'input-button task-option', title: 'toggle',
  ...
  const label = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('label', {class: 'visuallyhidden'});
  label.textContent = 'When';
  datePicker.appendChild(label);

  const dateInput = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('input', {type: 'text', class: 'visuallyhidden', placeholder: 'When', 'data-input': ''});
  label.appendChild(dateInput);

  initFlatpickr(datePicker, task, dateSpan);

  const btnPriority = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'task-option', 'aria-label': 'set-priority'});
  ...
  const btnEdit = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'task-option', 'aria-label': 'edit-task'});
  btnEdit.appendChild((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', { class: 'fas fa-edit'}));
  taskOptions.appendChild(btnEdit);

  const btnDelete = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'task-option', 'aria-label': 'delete-task'});
  btnDelete.appendChild((0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('i', {class: 'fas fa-trash-alt'}));
...
function displayDate(task, element) {
  ...
  if (task.dueDate) {
    const formDate = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.formatDate)(task.dueDate);
...
function handleEdit(e, task, project, li) {
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.focusAtEnd)(li.querySelector('.task-title'));
}


function showConfirmation(task, project, li) {
  const confWrapper = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {id: 'conf-wrapper', 'data-click': 'cancel'});
  
  const confDelete = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {id: 'conf-delete'});
  ...
  p.appendChild(text1);
  const span = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('span', {class: 'title-span'});
  span.textContent = `"${task.title}"`;
  p.appendChild(span);
  const text2 = document.createTextNode('?');
  p.appendChild(text2);

  const btnWrapper = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('div', {class: 'btn-conf-wrapper'});
  confDelete.appendChild(btnWrapper);

  const btnDelete = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-form btn-delete', 'data-click': 'delete'});
  btnDelete.textContent = 'Delete';
  btnWrapper.appendChild(btnDelete);

  const btnCancel = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', {type: 'button', class: 'btn-form btn-cancel', 'data-click': 'cancel'});
  btnCancel.textContent = 'Cancel';
...
function createTaskForm(project, task) {
  ...
  const btnCheck = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.createElemAttr)('button', 
...
function editTask(form, task, project) {
  ...
  if (newProjectId === project.id) {
    ...
    (0,_project_js__WEBPACK_IMPORTED_MODULE_2__.handleDeleteTask)(task, project, form.parentNode);
    newProject.addTask(task);
    (0,_navMenu_js__WEBPACK_IMPORTED_MODULE_1__.recalcTaskNumber)(newProject);
  }
}
