...
function createProjectHeader(project) {
  ...
  const btnOptions = createElemAttr('button', {
    type: 'button',
  ...
  btnOptions.addEventListener('click', () => renderProjectOptions(btnOptions, project));

  return header;
}

function renderProjectOptions(btnOptions, project) {
  ...
  btnDelComplete.append(
    createElemAttr('i', { class: 'fas fa-calendar-check' }),
